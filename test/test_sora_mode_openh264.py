...
def test_sora_mode_openh264_with_simulcast(sora_settings, free_port):
    ...
    with Momo(
        ...
        assert m.wait_for_connection(
            additional_wait_stats=[
                {"type": "codec", "mimeType": "video/H264"},
                {"type": "outbound-rtp", "rid": "r0", "encoderImplementation": "OpenH264"},
                {"type": "outbound-rtp", "rid": "r1", "encoderImplementation": "OpenH264"},
                {"type": "outbound-rtp", "rid": "r2", "encoderImplementation": "OpenH264"},
            ],
            additional_wait_stats_timeout=5,
        ...
        for simulcast_stat in simulcast_stats:
            assert simulcast_stat["encoderImplementation"] == "OpenH264"
