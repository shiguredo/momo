...
# AMD AMF 環境が有効でない場合もスキップ
pytestmark = pytest.mark.skipif(
    not os.environ.get("TEST_SORA_MODE_SIGNALING_URLS") or not os.environ.get("AMD_AMF"),
    reason="TEST_SORA_MODE_SIGNALING_URLS or AMD_AMF not set in environment",
)
...
def test_connection_stats(
    ...
    if video_codec_type == "AV1":
        ...
        encoder_params["h265_encoder"] = "amf"
...
def test_sora_sendonly_recvonly_pair(
    ...
    """Sora モードで sendonly と recvonly のペアを作成して送受信を確認（AMD AMF 使用）"""
    ...
    if video_codec_type == "AV1":
        ...
        decoder_params["h265_decoder"] = "amf"
