...
```
./momo --resolution VGA --no-audio --use-sdl --show-me ayame wss://ayame-lite.shiguredo.jp/signaling momo-sdl-ayame
```
...
```
./momo --resolution VGA --no-audio --use-sdl --show-me sora --video-codec VP8 --video-bitrate 1000 wss://example.com/signaling momo-sdl-sora --multistream
```
