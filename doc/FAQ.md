...
RaspberryPi の MJPEG デコーダ は [Logicool C920](https://www.logicool.co.jp/ja-jp/product/hd-pro-webcam-c920s) などの一部のカメラでしか機能しません。

対応したカメラをご用意いただくか、 `--hw-mjpeg-decoder false` にしてご利用ください。
