...
webrtc::scoped_refptr<sora::V4L2VideoCapturer> V4L2Capturer::Create(
...
webrtc::scoped_refptr<sora::V4L2VideoCapturer> V4L2Capturer::Create(
  ...
  webrtc::scoped_refptr<V4L2Capturer> v4l2_capturer =
      webrtc::make_ref_counted<V4L2Capturer>(config);
