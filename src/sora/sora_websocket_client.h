...
class SoraWebsocketClient : public std::enable_shared_from_this<SoraWebsocketClient>, public RTCMessageSender
{
...
public:
    SoraWebsocketClient(boost::asio::io_context& ioc, RTCManager* manager, ConnectionSettings conn_settings);
    void reset();
