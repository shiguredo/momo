    ...
    std::size_t bytes_transferred)
{
    ...
    if (req_.method() == boost::beast::http::verb::get)
    {
        ...
        {
            std::string state = Util::iceConnectionStateToString(ws_client_->getRTCConnectionState());
            json json_message = {
              {"state", state}
            };
...
boost::beast::http::response<boost::beast::http::string_body> SoraSession::createOKwithJson(const boost::beast::http::request<boost::beast::http::string_body>& req, json json_message) {
