...
[![libwebrtc](https://img.shields.io/badge/libwebrtc-m85.4183.2-blue.svg)](https://chromium.googlesource.com/external/webrtc/+/branch-heads/4183)
...
- Apple macOS に搭載されている H.264 や H.265 ハードウェアエンコーダー機能を [VideoToolbox](https://developer.apple.com/documentation/videotoolbox) 経由で利用しています
- NVIDIA Jetson に搭載されている H.264 や H.265 や VP9 ハードウェアエンコーダー機能を利用することで 4K@30 での配信が可能です
- NVIDIA ビデオカードに搭載されている H.264 や H.265 ハードウェアエンコーダー機能を [NVIDIA VIDEO CODEC SDK](https://developer.nvidia.com/nvidia-video-codec-sdk) 経由で利用しています
...
ハードウェアとセットで販売する場合はライセンス費用を支払う必要があります。

ただし、 Raspberry Pi においては H.264 のライセンスがハードウェア費用に含まれているため、
配布時にライセンス費用を支払う必要はありません。

詳細については [MPEG LA](https://www.mpegla.com/) まで問い合わせください。
...
H.265 ハードウェアエンコーダ **のみ** を利用している Momo 単体の配布においてはライセンス費用は不要ですが、
ハードウェアとセットで販売する場合はライセンス費用を支払う必要があります。

詳細については [MPEG LA](https://www.mpegla.com/) や [HEVC Advance](https://www.hevcadvance.com/) まで問い合わせてください。
